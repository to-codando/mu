...
import { AliasResolver, onRebuild, resolveEnvironment, type BuildHandlerParams } from "./config/plugins";
...
const config: BuildOptions = {
  ...
  platform: "browser",
  format: "esm",
  external: ["http", "canvas", "global-jsdom", "global-jsdom/register", "bun:test"],
